...
norlab_weights = np.load('../params/norlab_autorally_nn/norlab_autorally_nn_02_08_2021_01.npz')
...
np.savez('../params/norlab_autorally_nn/norlab_autorally_nn_02_08_2021_01.npz', dynamics_b1=b1, dynamics_b2=w2,
